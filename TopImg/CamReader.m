...
while get(handles.Scanning,'value')
    ...
    for i=1:N
        ...
        tempdate=datetime(tempname,'InputFormat','yyyy-MM-dd-HH;mm;ss');
        tempnamemodified=[datestr(tempdate,'mm-dd-yyyy_HH_MM_ss'),'_top.fits'];
        newnamelist=[[handles.outfolder,'\',tempnamemodified],newnamelist];
        newnamelistshow=[tempnamemodified,newnamelistshow];
